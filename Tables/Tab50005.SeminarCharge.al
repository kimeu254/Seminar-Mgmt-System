/// <summary>
/// Table Seminar Charge (ID 50005).
/// </summary>
table 50005 "Seminar Charge"
{
    ...
    begin
        SeminarCharge.Reset();
        SeminarCharge.SetRange("Document No.", "Document No.");
        if SeminarCharge.FindLast() then
            "Line No." := SeminarCharge."Line No.";
    end;
}
